...
const sed: SED = {
  ...
  notes: [
    "本计算器默认你可以完成前6关中所有非唯一指定限制车辆条件。祝你好运！"
  ],
  processRewords: [
    {
      conditions: 50,
      ...
      missions: [
        {
          ...
          toolCars: [
            { car_id: 'slr', freeTry: false, },
            { car_id: 'svr', freeTry: false, },
            { car_id: 'w70', freeTry: false, },
            { car_id: 'beast', freeTry: false, },
            { car_id: 'acr', freeTry: false, },
            { car_id: 'fordgt', freeTry: false, },
            { car_id: 'asterion', freeTry: false, },
            { car_id: 'h2', freeTry: false, },
            { car_id: 'nsx', freeTry: false, },
            { car_id: 'alfieri', freeTry: false, },
            { car_id: 'sarthe', freeTry: false, },
          ],
          rewords: [
      ...
      missions: [
        {
          ...
          toolCars: [
            ...
            { car_id: 'j50', freeTry: false, },
            { car_id: 'vipergts', freeTry: false, },
            { car_id: '488', freeTry: false, },
            { car_id: 'laferrari', freeTry: false, },
            { car_id: '003', freeTry: false, },
            { car_id: 'p1', freeTry: false, },
            { car_id: 'f12tdf', freeTry: false, },
            { car_id: 'cgs', freeTry: false, },
          ],
          rewords: [
      ...
      missions: [
        {
          ...
          toolCars: [
            { car_id: '570', freeTry: false, },
            { car_id: 'sv', freeTry: false, },
            { car_id: '1v10', freeTry: false, },
            { car_id: 'n', freeTry: false, },
            { car_id: 'slr', freeTry: false, },
            { car_id: '918', freeTry: false, },
            { car_id: 'evo', freeTry: false, },
          ],
          rewords: [
